          ...
          <div className='row justify-content-center'>
            <div className='col-lg-8'>
              <div className='service-details-wrap'>
                <div className='thumb'>
                  <img className='h-screen w-screen' src='assets/img/service/aeroplanecart.jfif' alt='Aero Swift' />
                  <div className='icon'>
                    <img className="rounded-full"
                      src='assets/img/about/291x356.jpeg'
                      alt='Aero Swift'
                    />
                  </div>
                </div>
                <h2 className=" font-serif text-center">AIR FRIEGHTS</h2>
                <p>
                At Aero Swift Logistic Limited, we provide fast, reliable air freight solutions for your urgent shipping needs. Our services ensure safe handling, timely delivery, and cost-effective solutions, both locally and internationally. Through our Global Transaction Advisory, we guide you through customs, compliance, and financial regulations. We are also committed to reducing our environmental impact by optimizing flight routes and adopting sustainable practices to minimize carbon emissions, ensuring a greener supply chain for your business.
