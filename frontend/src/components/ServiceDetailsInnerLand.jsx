          ...
          <div className='row justify-content-center'>
            <div className='col-lg-8'>
              <div className='service-details-wrap'>
                <div className='thumb'>
                  <img className='h-screen w-screen' src='assets/img/service-details/Landf.jfif' alt='Aero Swift' />
                  <div className='icon'>
                    <img className="rounded-full"
                      src='assets/img/service-details/Landf.jfif'
                      alt='Aero Swift'
                    />
                  </div>
                </div>
                <h2 className=" font-serif text-center">LAND FRIEGHTS</h2>
                <p>
                Aero Swift Logistic Limited offers reliable and efficient land 
                freight services to ensure the timely delivery of your goods 
                across various locations. Our extensive fleet of trucks and 
                vehicles is equipped to handle a wide range of cargo types, 
                from small parcels to bulk shipments. We provide flexible, 
                door-to-door transportation solutions tailored to your specific 
                needs, ensuring the safe and cost-effective movement of goods. 
                With real-time tracking and dedicated customer support, we make 
                land freight simple and hassle-free.
...
export default ServiceDetailsInnerLand;
