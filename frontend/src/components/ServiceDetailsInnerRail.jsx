          ...
          <div className='row justify-content-center'>
            <div className='col-lg-8'>
              <div className='service-details-wrap'>
                <div className='thumb'>
                  <img className='h-screen w-screen' src='assets/img/service-details/Railf.jfif' alt='Aero Swift' />
                  <div className='icon'>
                    <img className="rounded-full"
                      src='assets/img/service-details/Railf.jfif'
                      alt='Aero Swift'
                    />
                  </div>
                </div>
                <h2 className=" font-serif text-center">RAIL FRIEGHTS</h2>
                <p>
                Our rail freight services provide a cost-effective and efficient way to transport goods 
                across the country. With extensive rail networks and strategic partnerships, Aero Swift 
                Logistic Limited ensures timely deliveries and secure handling of cargo. 
                We offer customized solutions tailored to your shipping needs, ensuring minimal environmental impact while maximizing reliability. Trust us for seamless freight management, from dispatch to destination.
...
export default ServiceDetailsInnerRail;
