            ...
            <div className='col-lg-6 order-lg-2'>
              <div className='row'>
                <div className='col-md-6'>
                  <div className='thumb'>
                  <img
                    className='w-100 mask-image [mask-image:radial-gradient(white,_transparent)]'
                ...
                <div className='col-md-6'>
                  ...
                  <img
                    className='w-100 mask-image [mask-image:radial-gradient(white,_transparent)]'
                    src='assets/img/about/another.jpeg'
                    alt='Transpro'
                  />
              ...
              <div className='skill-progress-area'>
                ...
                <div className='single-progressbar'>
                  ...
                  <div className='progress-item' id='progress-running-1'>
                    ...
                    <div
                      id='progress-1'
                      className='progress-rate bg-gradient-to-r from-blue-300 to-violet-600'
                      data-value={80}
                      style={{ width: "80%" }}
                    ></div>
