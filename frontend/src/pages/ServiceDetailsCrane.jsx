...
const ServiceDetailsInnerCrane = React.lazy(() =>
  import("../components/ServiceDetailsInnerCrane")
);
    ...
    <>
      <Fragment>
        <Suspense fallback={<Preloader />}>
          ...
          {/* Breadcrumb */}
          <Breadcrumb title={"SERVICES DETAILS/CRANE AND FORKLIFT"} />

          {/* Service Details Inner */}
          <ServiceDetailsInnerCrane />
