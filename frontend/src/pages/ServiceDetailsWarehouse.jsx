...
import ServiceDetailsInnerWarehouse from "../components/ServiceDetailsInnerWarehouse";
    ...
    <>
      <Fragment>
        <Suspense fallback={<Preloader />}>
          ...
          {/* Breadcrumb */}
          <Breadcrumb title={"SERVICES DETAILS/WAREHOUSE"} />

          {/* Service Details Inner */}
          <ServiceDetailsInnerWarehouse />
